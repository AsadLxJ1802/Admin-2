import { NavItem, PATH } from "../components"

const SiteBar = () => {
  return (
    <div className="w-[22%] bg-linear-to-br from-slate-950 via-slate-900 to-indigo-950 text-slate-100 h-screen border-r-3 border-[#77738e] overflow-y-auto">
        <div className="p-5">
