...
const ProductCrud = () => {
  ...
  function hendleSubmid(evt:SubmitEvent<HTMLFormElement>) {
    setLoading(true)
    evt.preventDefault()
  ...
  useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white p-6">
          <form  onSubmit={hendleSubmid} autoComplete="off">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button extraClass="!w-25 flex items-center justify-center !h-[44px]" type="submit">
                {loading ? <img className="scale-[1.2]" src={LoadingWhite} alt="loading" width={30} height={30} /> : "Saqlash"}
              </Button>
            </div>
